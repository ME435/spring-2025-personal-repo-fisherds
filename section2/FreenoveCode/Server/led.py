...
# from rpi_ledpixel import Freenove_RPI_WS281X  # Pin 18 approach - fails anyway
from spi_ledpixel import Freenove_SPI_LedPixel  # SPI GPIO10 approach that works!
