...
class ADC:
    def __init__(self):
        ...
        self.adc_voltage_coefficient = 5.2              # Magic number back on the PCB
...
if __name__ == '__main__':
    ...
    try:
        while True:
            ...
            power = adc.read_adc(2) * 2      # Another magic number for battery voltage
            print(f"Left LDR: {left_idr}V, Right LDR: {right_idr}V, Battery Voltage: {power}V")  # Print the values of left IDR, right IDR, and power
